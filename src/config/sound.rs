...
impl Default for AgentSoundOverrides {
    fn default() -> Self {
        Self {
            ...
            shuvpi: AgentSoundSetting::Default,
...
"#;
        ...
        assert_eq!(config.ui.sound.agents.shuvpi, AgentSoundSetting::Off);
