...
| ShuvPi | lifecycle hooks when installed | state and session |
...
| ShuvCode | shared OpenCode lifecycle plugin when installed; otherwise OpenCode screen manifest | state and session |
